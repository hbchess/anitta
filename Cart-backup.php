...
<div class="col-sm-12 col-md-3">
    <div class="" >
        ...
        <div class="range-middle reveal-flex range-justify offset-top-10">
            <p class="text-spacing-40 text-light offset-bottom-0">Frete:</p>
            <p class="text-regular cart_totals-price">R$ 000,00</p>
        </div>
        <div class="range-middle reveal-flex range-justify offset-top-10">
...
<!-- CEP-->
<div class="col-sm-12 col-md-8 tudo2">
    <div class="cart_totals pull-sm-left">
    
    
    <?php if(!isset($_POST['cep'])){?>
        <h2 class="txt_center_bold text-light" style="font-size:16px;">Simule o prazo de entrega e o frete para o seu CEP abaixo:
        <br><br></h2>
        <form data-result-class="rd-mailform-validate" data-form-type="Subscribe" method="post" action="cart.php" >
            <div class="form-inline-flex reveal-xs-flex">
                <div class="form-group offset-bottom-0 offset-xs-top-20">
                    <input type="text" name="cep" placeholder="CEP" id="cep" maxlength="20" class="form-control"  data-constraints="@NotEmpty">
                </div>
            
                <button type="submit" class="btn btn-rosa offset-xs-left-10 offset-top-10 offset-xs-top-20">CALCULAR FRETE</button>
        ...
        <br><br>
         <h4 class="txt_center" style="font-size:16px; font-weight:300;"><b>Atenção:</b> O prazo de entrega é contado a partir da aprovação do pagamento.</h4>
         
    <?php }else{?>
    
    <div id="ceps" style=" ">Confira abaixo o prazo de entrega e o valor do frete para o CEP <b><?php echo $_POST['cep'];?></b> 
	
	<a><b><span class="font_rosa2"> Alterar CEP </span></a></b>
    
	<div id="dentrocep" style=""></div>
	<br />
    <div id="vercep" style=" ">
	<input type="radio"> Rápida | Até 10 dias: R$ 19,90<br>
	<br>
    <input type="radio"> econômica | Até 14 dias: Grátis<br>
	<br>
	<input type="radio"> E-sedex | Até 4 dias: Grátis
    </div>
    </div>
